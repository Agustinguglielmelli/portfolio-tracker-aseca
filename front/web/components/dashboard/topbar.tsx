    ...
    <header className="h-16 shrink-0 border-b border-white/5 bg-[#0a1224]/60 backdrop-blur-xl flex items-center px-6 gap-6">
      ...
      <div className="flex items-center gap-3 ml-auto">
        ...
        <button
          onClick={onRefresh}
          disabled={refreshing}
          className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-cyan-300 hover:border-cyan-400/50 hover:shadow-[0_0_10px_rgba(56,189,248,0.2)] transition-all disabled:opacity-50"
        >
